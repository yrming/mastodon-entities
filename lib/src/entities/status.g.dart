...
_StatusMention _$StatusMentionFromJson(Map<String, dynamic> json) =>
    _StatusMention(
      id: json['id'] as String?,
...
Map<String, dynamic> _$StatusMentionToJson(_StatusMention instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_StatusTag _$StatusTagFromJson(Map<String, dynamic> json) =>
    _StatusTag(name: json['name'] as String?, url: json['url'] as String?);

Map<String, dynamic> _$StatusTagToJson(_StatusTag instance) =>
